...
const NavBarContent = () => {
  ...
  return (
    <>
      ...
      <header
        className={`fixed top-0 left-0 right-0 z-30 backdrop-blur-md transition-all duration-300 ${isScrolled ? 'bg-white/90 dark:bg-gray-900/90 shadow-sm' : 'bg-transparent'}`}
      >
